...
import { findingLabels, stageLabels } from "../shared/labels";
import { ResultViews } from "./result-views";
import { Icon, type IconName } from "./ui-icons";
import { AnalysisModeAlert, AnalysisModePanel, MethodBadge } from "./analysis-mode";
...
function Dashboard({ result, view, onNavigate, onReview }: { result: AnalysisResult; view: WorkspaceView; onNavigate: (view: WorkspaceView) => void; onReview: (finding: Finding) => void }) {
  ...
  return <>
    ...
    <AnalysisModeAlert mode={result.analysisMode} />
    ...
    {view === "findings" && <AnalysisModePanel mode={result.analysisMode} />}
